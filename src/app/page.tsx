...
import { FeatureCard } from "@/components/v0/feature-card"
import { ProcessStep } from "@/components/v0/process-step"
import { PricingCard } from "@/components/v0/pricing-card"
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Process Section */}
      <section id="process" className="py-24 px-4 bg-card border-y">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
